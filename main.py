...
class User(db.Model):
    ...
    # instead of UserMixin ( which is used to multiple inheritance in python) below 4 methods are created .got from Q&A section.
    # because Usermixin was giving unexpected argument messages on pycharm for new_user definition.
    def is_active(self):
        return True
